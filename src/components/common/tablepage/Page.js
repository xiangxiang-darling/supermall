 function tablepages(dataNum) {
        let table = document.querySelector('.tabletext')
        let pagefather = document.querySelector('.page')
        let pageNum
        let tr=dataNum
        ...
        for(let i=0;i<pageNum;i++) {
            ...
            let newbtn=document.createElement('span')
                newbtn.innerHTML = " <a href='javascript:;' class='btnn"+num+"'>"+num+"</a>"
        ...
        //页面跳转(下一页)
        let beforpage = document.querySelector('.btnbefor')
        ...
        //首页
        let firstpage = document.querySelector('.btnfirst')
        firstpage.onclick = function() {
            index=0
            table.style.transform="translate(0px,"+index+"px)"
        }
        //末页
        let lastpage = document.querySelector('.btnlast')
